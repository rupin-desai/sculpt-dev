...
const HeroTitle = ({ title, subtitle }) => {
  ...
  const scrollCenterToTop = useTransform(scrollYProgress, [0.5, 0], [0, 360]); // Scroll from center to top
  const rotateArrow = useTransform(scrollYProgress, [1, 0], [0, 720]); // Arrow rotation from center to top
  ...
  return (
    <div className="w-full text-left pt-0 sm:px-0 md:pd-0 ">
      ...
      />
        ...
        <motion.div
          className="flex w-full sm:w-7/12 items-start text-lg sm:text-xl text-gray-600 pl-10"
