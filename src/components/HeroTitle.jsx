...
const HeroTitle = ({ title, subtitle }) => {
  ...
  return (
    <div className="w-full text-left pt-0 sm:px-0 md:pd-0 ">
      ...
      <motion.h1
        className="flex lg:leading-snug lg:tracking-tighter  items-start w-full pt-10 text-2xl font-medium text-black sm:text-3xl md:text-5xl lg:text-7xl xl:pt-32 "
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <motion.div
          className="flex lg:leading-snug lg:text-xl leading-10 w-full sm:w-7/12 items-start text-lg sm:text-xl text-black pl-10"
